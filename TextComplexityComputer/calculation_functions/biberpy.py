...
def getbiberdims(doc):
    ...
    dimlist[dimnames['E16']] = (simplePartsOfSpeech(doc, "NOUN")[0]/normalise)-dimlist[dimnames['E14']] # we substract nominalizations
    ...
    dimlist[dimnames['H34']] = posWithLemmaFilter(doc,'',"sentenceRelatives")/normalise # Bob likes fried mangoes, which is the most disgusting
