...
from TextComplexityComputer.calculation_functions import syntactic_complexity as sc
...
class TestPs30(TestCase):
    def test_givenText_thenGetMetric(self):
        ...
        text = 'Je ronge les lapins. En outre le poivre en addition au sel permet de relever un je ne sais quoi lors ' \
    ...
    def test_givenTextWithPunctuations_thenGetMetric(self):
        ...
        text = 'Je ronge les lapins. Le poivre, en addition, au sel permet de: relever un je ne sais quoi, lors ' \
...
class TestGetTUnits(TestCase):
    ...
    def test_givenTextWithTripleNesting_whenComplexCountIsTrue_thenGetComplexAndBaseTUnits(self):
    ...
    def test_givenTextWithDependentClause_whenComplexCountIsTrue_thenGetComplexAndBaseTUnits(self):
    ...
    def test_givenComplexTextWithDependentClause_whenComplexCountIsTrue_thenGetComplexAndBaseTUnits(self):
        # 1 matrix plus subordinate clause (complex) -> 1 T-Unit, 1 Complex
...
class TestGetClauses(TestCase):
    ...
    def test_givenComplexText_whenDependentCountIsTrue_thenGetDependentAndBaseClauses(self):
